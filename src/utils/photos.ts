// To parse this data:
//
//   import { Convert, Photos } from "./file";
//
//   const photos = Convert.toPhotos(json);
//
...
export class Convert {
    public static toPhotos(json: string): Photos {
        return cast(JSON.parse(json), r("Photos"));
    }

    public static photosToJson(value: Photos): string {
        return JSON.stringify(uncast(value, r("Photos")), null, 2);
    }
}
